...
#define Ny 2				// number of Nodes in x direction, must be at least 1
#define Nz 2				// number of Nodes in x direction, must be at least 1
#define N  Nx*Ny*Nz			// number of Nodes in total
#define GNx 40				// number of Grid in x direction
#define GNy 40				// number of Grid in x direction
#define GNz 40				// number of Grid in x direction

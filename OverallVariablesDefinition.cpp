...
double starty = -6;			// starting position's y component
double startz = -.5;		// starting position's z component
double Interval12x = .5;	// x distance between 1st and 2nd spacecraft
double Interval12y = .5;	// y distance between 1st and 2nd spacecraft
...
double Interval14y = .25;	// y distance between 1st and 4th spacecraft
